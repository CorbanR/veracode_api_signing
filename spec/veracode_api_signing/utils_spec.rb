...
RSpec.describe VeracodeApiSigning::Utils do
  ...
  describe ".get_host_from_url" do
    context "when valid host" do
      it "returns host" do
        host = utils.get_host_from_url("https://www.foomanchoo.com/api/v1")
    ...
    context "when invalid host" do
      it "returns nil" do
        host = utils.get_host_from_url("foomancho")
  ...
  describe ".get_path_and_params_from_url" do
    context "with path" do
      context "without params" do
        it "returns path" do
          path = utils.get_path_and_params_from_url("https://www.foomanchoo.com/api/v1")
      ...
      context "with params" do
        it "returns path + params" do
          path = utils.get_path_and_params_from_url("https://www.foomanchoo.com/api/v1?foo=bar")
          expect(path).to eq("/api/v1?foo=bar")
        end

        it "returns longer path + params" do
          path = utils.get_path_and_params_from_url("https://www.foomanchoo.com/api/v1?pagesize=2&page=90")
    ...
    context "without path" do
      context "without params" do
        it "returns path + params" do
          path = utils.get_path_and_params_from_url("https://www.foomanchoo.com")
          expect(path).to eq("")
        end
      end
    end
  ...
  describe ".get_scheme_from_url" do
    context "with scheme" do
      it "returns https scheme" do
        scheme = utils.get_scheme_from_url("https://www.foomanchoo.com")
        expect(scheme).to eq("https")
      end

      it "returns http scheme" do
        scheme = utils.get_scheme_from_url("http://www.foomanchoo.com")
    ...
    context "without scheme" do
      it "returns empty string" do
        scheme = utils.get_scheme_from_url("www.foomanchoo.com")
        expect(scheme).to eq("")
      end
    end
  end
